 ...
 */
let cheeseSandwich: [String] = ["Bread", "Butter", "Cheese", "Lettuce"]
...
// dont understand why this is not working. Keeps on saying missing argument but when I put ingredients as label, it prints something else
