...
func lifeEssential(ingrediants: [String]) -> Bool {
    
    if ingrediants[0] == "Bread" {
        return true
    } else {
        return false
    }
...
lifeEssential(ingrediants: shoppingList)
print(lifeEssential(ingrediants: shoppingList))
...
print(lifeEssential(ingrediants: dessertList))
